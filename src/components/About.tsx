    ...
    <section id='about' className='w-full h-screen grid grid-cols-2'>
      ...
      <div className='flex flex-col justify-center'>
        ...
        <p className='my-12'>
          ...
          majoring in Computer Science and Neuroscience. I enjoy using
          technology to solve real-world problems. My passions include
          cybersecurity, machine learning, and connectomics. When I&apos;m not
          coding or reading papers, you can find me practicing piano or guitar.
        </p>
