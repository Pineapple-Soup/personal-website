    ...
    <section id="about" className="w-full h-screen grid grid-cols-2 gap-16">
      <div className="h-screen grid grid-cols-5 grid-rows-6">
        <div
          ...
          onMouseOut={() => setHover('')}
        >
          <ComputerScienceIcon className={`fill-current ${hover == 'cs' ? 'text-accent' : ''}`} />
        </div>
        <div
          ...
          onMouseOut={() => setHover('')}
        >
          <NeuroscienceIcon className={`fill-current ${hover == 'ns' ? 'text-accent' : ''}`} />
        </div>
        <div
          ...
          onMouseOut={() => setHover('')}
        >
          <NetworkIcon className={`fill-current ${hover == 'nw' ? 'text-accent' : ''}`} />
        </div>
        <div
          ...
          onMouseOut={() => setHover('')}
        >
          <MusicIcon className={`fill-current ${hover == 'm' ? 'text-accent' : ''}`} />
        </div>
      </div>
